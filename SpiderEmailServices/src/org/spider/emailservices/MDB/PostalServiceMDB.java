package org.spider.emailservices.MDB;
...
import org.spider.emailservices.StatelessBean.RequestHandler;
import org.spider.emailservices.StatelessBean.RequestHandlerLocal;
import org.spider.emailservices.Utilities.QueueProcess;

/**
 * Message-Driven Bean implementation class for: FeesSchool
 */
@MessageDriven(
		activationConfig = { 
				@ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/spiderpostbox"), 
				@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
				@ActivationConfigProperty(propertyName = "subscriptionDurability", propertyValue = "Durable"),
				@ActivationConfigProperty(propertyName = "clientID", propertyValue = "spiderpostbox"),
...
//		mappedName = "java:/jms/queue/spiderpostbox")
		mappedName = "java:/queue/spiderpostbox")


public class PostalServiceMDB implements MessageListener {
	@EJB(lookup="java:module/RequestHandler")
	private RequestHandlerLocal reqHandle;
	QueueConnection connection;
	QueueSession session;
	MessageProducer messageProducer;
	String appName  = "spiderpostbox";
	public Configurations loadConf = new Configurations();
	private static final Logger LOGGER = Logger.getLogger(PostalServiceMDB.class.getName());
